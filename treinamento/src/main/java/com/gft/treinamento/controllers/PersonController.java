...
public class PersonController {
	...
	@RequestMapping (method = RequestMethod.GET, path = "/new")/*criar novo usuario*/
	...
	@RequestMapping (method = RequestMethod.GET, path = "/edit")/*metodo editar*/
	...
	@RequestMapping (method = RequestMethod.GET, path = "/delete")/*metodo de deletar*/
	public ModelAndView deletePerson (@RequestParam Long id, RedirectAttributes redirectAttributes) {
		...
		try {
			...
			redirectAttributes.addFlashAttribute("message","Erro ao excluir pessoa, possivelmente ela não existe");
		}
		return mv;
	}
